                                    ...
                                    return(
                                        <div className='w3-margin-top'>
                                            ...
                                            <div id={ind} className="w3-hide w3-padding">
                                                <div>{arr['Chat'].map(arr=>{return <p className='w3-round w3-padding w3-deep-orange w3-margin-top'>{arr['sender']}: {arr['mesage']}</p>})}</div>
            ...
            return(
                <div className='w3-row'>
                    <div className='w3-col s12 m6 l6 w3-padding'>
                        ...
                        <div className='w3-container' id='chats'>
                            {
                                this.state.chat.map((arr, ind)=>{
                                    return(
                                        <div className='w3-margin-top'>
